...
import '../widgets/update_card_widget.dart';
...
class _FeedsPageState extends State<FeedsPage> with TickerProviderStateMixin {
 ...
 // List<ExploreUpdate> listExploreUpdateItem = ExploreService.listExploreUpdateItem;
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<ExploreService>(context);
    final listExploreItem = provider.listExploreItem;
    final listExploreUpdateItem = provider.listExploreUpdateItem;
