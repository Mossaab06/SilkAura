      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            Text(' ${cartData.length.toString()} items ',
                style: TextStyle(
        ...
        leading: IconButton(
          onPressed: () {
            if(cartData!=provider.cartData){
              provider.storeCartData();
            }
        ...
        children: [
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return CartTile(
              cartData:cartData, index: index, productCount: cartData[index].count,
              );
            },
