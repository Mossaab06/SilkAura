...
import 'package:e_commerce/views/Screens/reviews_page.dart';
...
import '../widgets/modals/add_to_cart_modal.dart';
import '../widgets/rating_tag.dart';
import '../widgets/review_tile.dart';
import '../widgets/selectable_circle_color.dart';
import '../widgets/selectable_circle_size.dart';
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ImageViewer(imageUrl: product.image as List<String>),
                    ),
                  );
                },
                child: Container(
