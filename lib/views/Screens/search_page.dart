import 'package:e_commerce/views/Screens/search_result_page.dart';
...
import '../widgets/popular_search_card.dart';
...
class _SearchPageState extends State<SearchPage> {
 // List<SearchHistory> listSearchHistory = SearchService.listSearchHistory;
  ...
  Widget build(BuildContext context) {
    ...
    final listSearchHistory = provider.listSearchHistory;
    final listPopularSearch = provider.listPopularSearch;
    return Scaffold(
      appBar: AppBar(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  print('---------------------------' + listSearchHistory[index].title);
